pub fn process(input: &str) -> String {
    ...
    let mut power_of_cubes: Vec<i32> = vec![];
    ...
    for line in input.lines() {
        ...
        power_of_cubes.push(max_red * max_blue * max_green);
    }

    println!("Possible games {:#?}", power_of_cubes);

    power_of_cubes.iter().fold(0, |acc, x| acc + x).to_string()
}
